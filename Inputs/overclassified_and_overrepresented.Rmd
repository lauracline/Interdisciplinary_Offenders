...
The Area Under the Curve model (Table \@ref(tab:auc1)) (Figure \@ref(fig:perf1)) demonstrates that our model correctly predicted 72.31% of inmates as having a maximum security level or not using their race and age. Thus, the maximum security model has moderatly high validity. 
