...
huxreg("Logistic Regression Model for High Reintegration Potential Using Race, Age and Sentence Length" = reintegration_potential_model, number_format = 5, bold_signif = 0.05)
```
