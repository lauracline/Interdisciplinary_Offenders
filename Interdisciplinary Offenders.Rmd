...
```{r}
# Turn Offense Categories into Weights 
female_ds$offence_weight <- female_ds$offence_description
```
...
## Race and Inmate's Security Level 
...
summary(offender_security_level_model)
```

## Race and Inmate's Reintegration Score
...
summary(reintegration_potential_model)
```




## Reintegration Score and Reoffending 